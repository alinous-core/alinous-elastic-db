...
bool CommitStatement::__init_static_variables(){
 ...
 CommitStatement::CommitStatement(ThreadContext* ctx) throw()  : IObject(ctx), AbstractSQLStatement(ctx)
{
}
void CommitStatement::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void CommitStatement::__cleanUp(ThreadContext* ctx){
}
}}}
