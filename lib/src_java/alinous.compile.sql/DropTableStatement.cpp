...
bool DropTableStatement::__init_static_variables(){
 ...
 DropTableStatement::DropTableStatement(ThreadContext* ctx) throw()  : IObject(ctx), AbstractSQLStatement(ctx), table(nullptr)
{
}
void DropTableStatement::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void DropTableStatement::__cleanUp(ThreadContext* ctx){
}
}}}
