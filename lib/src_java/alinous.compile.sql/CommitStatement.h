#ifndef ALINOUS_COMPILE_SQL_COMMITSTATEMENT_H_
#define ALINOUS_COMPILE_SQL_COMMITSTATEMENT_H_
...
class CommitStatement final : public AbstractSQLStatement {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_COMMITSTATEMENT_H_ */
