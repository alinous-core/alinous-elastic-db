...
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::db::table::LocalOidCounter>;
...
template class ::java::util::HashMapKeySet<::java::lang::Long, ::alinous::remote::db::server::scan::AbstractStorageScanSession>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::client::command::data::ClientTableData>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::client::DatabaseTableClient>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::client::TableAccessStatus>;
...
template class ::java::util::HashMapKeySet<::java::lang::Long, ::alinous::remote::region::server::lock::RemoteTrxLockContext>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::server::lock::IRemoteTableLock>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::server::lock::TrxLockContextLockHolder>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::server::schema::NodeReference>;
template class ::java::util::HashMapKeySet<::java::lang::Long, ::alinous::remote::region::server::tpc::RegionInsertExecutor>;
template class ::java::util::HashMapKeySet<::java::lang::Long, ::alinous::remote::region::server::tpc::CommitClusterNodeListner>;
...
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::db::table::TablePartitionRange>;
...
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::server::schema::strategy::InsertNodeAccessStrategy>;
template class ::java::util::HashMapKeySet<::java::lang::String, ::alinous::remote::region::server::schema::strategy::UniqueCheckOperation>;
