template class ::java::util::HashMap<::java::lang::String, ::java::util::TimeZone>;
template class ::java::util::HashMap<::java::lang::String, ::org::alinous::charset::CharsetConverter>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::system::config::AlinousDbInstanceInfo>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::analyse::DomVariableDeclareSource>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::analyse::ClassDeclareHolder::ClassDeclares>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::declare::AlinousClass>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::analyse::TypedVariableDeclareSource>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::sql::analyze::ScanTableMetadata>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::sql::functions::ISQLFunctionBody>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::compile::declare::function::AlinousFunction>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::AlinousModule>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::dbif::IDatabaseDriver>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::dom::IDomVariable>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::dom::typed::ITypedVariable>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::dom::IAlinousVariable>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::function::AlinousNativeFunctionRegistory::FuncHolder>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::runtime::function::IAlinousNativeFunction>;
template class ::java::util::HashMap<::java::lang::String, ::alinous::server::http::params::AbstractHttpParameter>;
...
template class ::java::util::HashMap<::java::lang::String, ::alinous::db::table::TablePartitionRange>;
...
template class ::java::util::HashMap<::java::lang::String, ::alinous::remote::region::client::TableAccessStatus>;
