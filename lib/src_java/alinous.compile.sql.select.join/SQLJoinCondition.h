#ifndef ALINOUS_COMPILE_SQL_SELECT_JOIN_SQLJOINCONDITION_H_
#define ALINOUS_COMPILE_SQL_SELECT_JOIN_SQLJOINCONDITION_H_
...
class SQLJoinCondition final : public AbstractSQLBooleanExpression {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_SELECT_JOIN_SQLJOINCONDITION_H_ */
