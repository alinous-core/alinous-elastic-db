#ifndef ALINOUS_COMPILE_SQL_SELECT_JOIN_JOINSUBQUERYTARGET_H_
#define ALINOUS_COMPILE_SQL_SELECT_JOIN_JOINSUBQUERYTARGET_H_
...
class JoinSubQueryTarget final : public AbstractJoinTarget {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_SELECT_JOIN_JOINSUBQUERYTARGET_H_ */
