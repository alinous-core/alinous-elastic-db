...
bool IJoinTarget::__init_static_variables(){
 ...
 IJoinTarget::IJoinTarget(ThreadContext* ctx) throw()  : IObject(ctx), IJoin(ctx)
{
}
void IJoinTarget::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IJoinTarget::__cleanUp(ThreadContext* ctx){
}
}}}}}
