#ifndef ALINOUS_REMOTE_REGION_CLIENT_REMOTEREVERSEINDEXSCANNER_H_
#define ALINOUS_REMOTE_REGION_CLIENT_REMOTEREVERSEINDEXSCANNER_H_
...
using ::alinous::remote::region::client::scan::IRemoteJoinScanner;
...
public:
	RemoteReverseIndexScanner(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~RemoteReverseIndexScanner() throw();
	virtual void __releaseRegerences(bool prepare, ThreadContext* ctx) throw();
public:
	RemoteReverseIndexScanner* init(DbTransaction* trx, ITableTargetScanner* left, ITableTargetScanner* right, ScanTableMetadata* leftMetadata, ScanTableMetadata* rightMetadata, bool inner, JoinMatchExpression* match, SQLJoinCondition* condition, ScriptMachine* machine, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_REMOTE_REGION_CLIENT_REMOTEREVERSEINDEXSCANNER_H_ */
