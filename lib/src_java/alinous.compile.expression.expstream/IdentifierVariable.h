#ifndef ALINOUS_COMPILE_EXPRESSION_EXPSTREAM_IDENTIFIERVARIABLE_H_
#define ALINOUS_COMPILE_EXPRESSION_EXPSTREAM_IDENTIFIERVARIABLE_H_
...
class IdentifierVariable final : public IAlinousVariable, public virtual IObject {
public:
	IdentifierVariable(const IdentifierVariable& base) = default;
public:
	IdentifierVariable(DomVariableDescriptor* id, ThreadContext* ctx) throw() ;
	void __construct_impl(DomVariableDescriptor* id, ThreadContext* ctx) throw() ;
	IdentifierVariable(String* id, ThreadContext* ctx) throw() ;
...
public:
	...
	void addDomArrayIndex(int index, ThreadContext* ctx) throw() ;
	bool isDomDescriptor(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_COMPILE_EXPRESSION_EXPSTREAM_IDENTIFIERVARIABLE_H_ */
