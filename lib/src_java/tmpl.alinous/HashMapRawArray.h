...
template class ::alinous::HashMapRawArray<::java::lang::String, ::alinous::lock::unique::ColumnsUniqueCollections>;
...
template class ::alinous::HashMapRawArray<::java::lang::String, ::alinous::remote::region::client::TableAccessStatus>;
...
template class ::alinous::HashMapRawArray<::java::lang::String, ::alinous::db::table::TablePartitionRange>;
...
template class ::alinous::HashMapRawArray<::java::lang::String, ::alinous::remote::region::server::schema::strategy::InsertNodeAccessStrategy>;
template class ::alinous::HashMapRawArray<::java::lang::String, ::alinous::remote::region::server::schema::strategy::UniqueCheckOperation>;
