...
bool DebugProbe::__init_static_variables(){
 ...
 DebugProbe::DebugProbe(ThreadContext* ctx) throw()  : IObject(ctx), list(GCUtils<ArrayList<DebugProbeSection> >::ins(this, (new(ctx) ArrayList<DebugProbeSection>(ctx)), ctx, __FILEW__, __LINE__, L""))
{
}
void DebugProbe::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void DebugProbe::__cleanUp(ThreadContext* ctx){
