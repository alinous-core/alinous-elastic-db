...
{
	return (ConstStr::getCNST_STR_1204()->clone(ctx)->append(errorLine, ctx)->append(ConstStr::getCNST_STR_1205(), ctx)->append(errorColumn, ctx)->append(ConstStr::getCNST_STR_1206(), ctx)->append((EOFSeen ? ConstStr::getCNST_STR_1207() : (ConstStr::getCNST_STR_1208()->clone(ctx)->append(addEscapes(String::valueOf(curChar, ctx), ctx), ctx)->append(ConstStr::getCNST_STR_1208(), ctx))->clone(ctx)->append(ConstStr::getCNST_STR_887(), ctx)->append(((int)curChar), ctx)->append(ConstStr::getCNST_STR_1209(), ctx)), ctx)->append(ConstStr::getCNST_STR_1210(), ctx)->append(addEscapes(errorAfter, ctx), ctx)->append(ConstStr::getCNST_STR_1208(), ctx));
}
}}
