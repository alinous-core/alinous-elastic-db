...
{
	return (ConstStr::getCNST_STR_1294()->clone(ctx)->append(errorLine, ctx)->append(ConstStr::getCNST_STR_1295(), ctx)->append(errorColumn, ctx)->append(ConstStr::getCNST_STR_1296(), ctx)->append((EOFSeen ? ConstStr::getCNST_STR_1297() : (ConstStr::getCNST_STR_1298()->clone(ctx)->append(addEscapes(String::valueOf(curChar, ctx), ctx), ctx)->append(ConstStr::getCNST_STR_1298(), ctx))->clone(ctx)->append(ConstStr::getCNST_STR_887(), ctx)->append(((int)curChar), ctx)->append(ConstStr::getCNST_STR_1299(), ctx)), ctx)->append(ConstStr::getCNST_STR_1300(), ctx)->append(addEscapes(errorAfter, ctx), ctx)->append(ConstStr::getCNST_STR_1298(), ctx));
}
}}
