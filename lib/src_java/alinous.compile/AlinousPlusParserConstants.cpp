...
bool AlinousPlusParserConstants::__init_static_variables(){
 ...
 AlinousPlusParserConstants::AlinousPlusParserConstants(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void AlinousPlusParserConstants::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void AlinousPlusParserConstants::__cleanUp(ThreadContext* ctx){
}
}}
