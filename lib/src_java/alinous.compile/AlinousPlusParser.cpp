...
DomVariableDescriptor* AlinousPlusParser::domVariableDescriptor(ThreadContext* ctx)
{
	...
	label_30_out_break: ;
	if(t->image->equals(ConstStr::getCNST_STR_1321(), ctx))
	{
		desc->markLastSegmentAsArray(ctx);
	}
	if(segment == nullptr)
...
Token* AlinousPlusParser::nameIdentifier(ThreadContext* ctx)
{
	...
	case READ:
		{
			t = jj_consume_token(READ, ctx);
			break ;
		}
	case COMMITTED:
		{
			t = jj_consume_token(COMMITTED, ctx);
			break ;
		}
	case SERIALIZABLE:
		{
			t = jj_consume_token(SERIALIZABLE, ctx);
			break ;
		}
	default:
...
Token* AlinousPlusParser::assignmentOperator(ThreadContext* ctx)
{
	...
	case 211:
		{
			t = jj_consume_token((long long)211, ctx);
			break ;
		}
	case 212:
		{
			t = jj_consume_token((long long)212, ctx);
			break ;
		}
	default:
...
BeginStatement* AlinousPlusParser::beginStatement(ThreadContext* ctx)
{
	...
	case TRANSACTION:
		{
			jj_consume_token(TRANSACTION, ctx);
			jj_consume_token(ISOLATION, ctx);
			jj_consume_token(LEVEL, ctx);
			switch((jj_ntk == (long long)-1) ? jj_ntk_f(ctx) : jj_ntk) {
			case READ:
				{
					jj_consume_token(READ, ctx);
					jj_consume_token(COMMITTED, ctx);
					stmt->setIsolationLevel(IDatabaseDriver::READ_COMMITTED, ctx);
					break ;
				}
			case SERIALIZABLE:
				{
					jj_consume_token(SERIALIZABLE, ctx);
					stmt->setIsolationLevel(IDatabaseDriver::SERIALIZABLE, ctx);
					break ;
				}
			default:
	...
	case 213:
		{
			...
			case 213:
				{
					t = jj_consume_token((long long)213, ctx);
					break ;
				}
			case CMP_NOTEQUALS:
				{
...
ParseException* AlinousPlusParser::generateParseException(ThreadContext* ctx)
{
	...
	IArrayObjectPrimitive<bool>* la1tokens = ArrayAllocatorPrimitive<bool>::allocatep(ctx, 214);
	...
	for(long long i = 0; i < (long long)214; i ++ )
	{
		if(la1tokens->get(i))
		{
...
bool AlinousPlusParser::jj_3R_228(ThreadContext* ctx)
{
	...
	{
		__GC_MV(this, &(jj_scanpos), xsp, Token);
		if(jj_scan_token((long long)213, ctx))
		{
			__GC_MV(this, &(jj_scanpos), xsp, Token);
						...
						if(jj_scan_token((long long)207, ctx))
						{
							...
							if(jj_scan_token((long long)208, ctx))
							{
								...
								if(jj_scan_token((long long)209, ctx))
								{
									...
									{
										__GC_MV(this, &(jj_scanpos), xsp, Token);
										if(jj_scan_token((long long)211, ctx))
										{
											__GC_MV(this, &(jj_scanpos), xsp, Token);
											if(jj_scan_token((long long)212, ctx))
											{
												return true;
											}
										}
																																																																																										...
																																																																																										if(jj_scan_token((long long)84, ctx))
																																																																																										{
																																																																																											...
																																																																																											if(jj_scan_token((long long)186, ctx))
																																																																																											{
																																																																																												...
																																																																																												if(jj_scan_token((long long)187, ctx))
																																																																																												{
																																																																																													...
																																																																																													{
																																																																																														__GC_MV(this, &(jj_scanpos), xsp, Token);
																																																																																														if(jj_scan_token((long long)190, ctx))
																																																																																														{
																																																																																															__GC_MV(this, &(jj_scanpos), xsp, Token);
																																																																																															if(jj_scan_token((long long)191, ctx))
																																																																																															{
																																																																																																__GC_MV(this, &(jj_scanpos), xsp, Token);
...
void AlinousPlusParser::__cleanUp(ThreadContext* ctx){
...
bool AlinousPlusParser::LookaheadSuccess::__init_static_variables(){
 ...
 AlinousPlusParser::LookaheadSuccess::LookaheadSuccess(ThreadContext* ctx) throw()  : IObject(ctx), java::lang::Error(ctx)
{
}
void AlinousPlusParser::LookaheadSuccess::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void AlinousPlusParser::LookaheadSuccess::__cleanUp(ThreadContext* ctx){
}
}}
...
bool AlinousPlusParser::JJCalls::__init_static_variables(){
 ...
 AlinousPlusParser::JJCalls::JJCalls(ThreadContext* ctx) throw()  : IObject(ctx), gen(0), first(nullptr), arg(0), next(nullptr)
{
}
void AlinousPlusParser::JJCalls::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void AlinousPlusParser::JJCalls::__cleanUp(ThreadContext* ctx){
}
}}
