...
bool DatabaseTable::__init_static_variables(){
 ...
 DatabaseTable::DatabaseTable(RecordCacheEngine* cacheEngine, String* schema, String* name, String* baseDir, ThreadContext* ctx) throw()  : IObject(ctx), DatatableUpdateSupport(schema, name, baseDir, ctx)
{
	__GC_MV(this, &(this->cacheEngine), cacheEngine, RecordCacheEngine);
}
void DatabaseTable::__construct_impl(RecordCacheEngine* cacheEngine, String* schema, String* name, String* baseDir, ThreadContext* ctx) throw() 
{
	__GC_MV(this, &(this->cacheEngine), cacheEngine, RecordCacheEngine);
}
