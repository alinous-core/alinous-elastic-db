...
bool RegionInfoData::__init_static_variables(){
 ...
 RegionInfoData::RegionInfoData(ThreadContext* ctx) throw()  : IObject(ctx), ICommandData(ctx), nodeInfo(nullptr)
{
}
void RegionInfoData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void RegionInfoData::__cleanUp(ThreadContext* ctx){
}
}}}}}}
