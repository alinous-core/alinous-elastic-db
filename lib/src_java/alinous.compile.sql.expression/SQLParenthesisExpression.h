#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_SQLPARENTHESISEXPRESSION_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_SQLPARENTHESISEXPRESSION_H_
...
class SQLParenthesisExpression final : public AbstractSQLExpression {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_SQLPARENTHESISEXPRESSION_H_ */
