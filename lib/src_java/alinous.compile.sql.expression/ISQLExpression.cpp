...
bool ISQLExpression::__init_static_variables(){
 ...
 ISQLExpression::ISQLExpression(ThreadContext* ctx) throw()  : IObject(ctx), IExpression(ctx)
{
}
void ISQLExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ISQLExpression::__cleanUp(ThreadContext* ctx){
}
}}}}
