#ifndef ALINOUS_REMOTE_DB_COMMAND_TERMINATEREMOTESTORAGECOMMAND_H_
#define ALINOUS_REMOTE_DB_COMMAND_TERMINATEREMOTESTORAGECOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_DB_COMMAND_TERMINATEREMOTESTORAGECOMMAND_H_ */
