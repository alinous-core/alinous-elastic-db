...
String* NotifyThreadStartCommand::CMD_STRING = ConstStr::getCNST_STR_1211();
...
{
	notifier->debugOut(ConstStr::getCNST_STR_1210()->clone(ctx)->append(this, ctx), ctx);
}
...
void NotifyThreadStartCommand::__cleanUp(ThreadContext* ctx){
}
}}}}}
