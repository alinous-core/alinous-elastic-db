...
public:
	...
	constexpr static StaticUnicodeString __CNST_STR_1704{L"primary key is wrong",20};
public:
...
public:
	...
	constexpr static StaticUnicodeString __CNST_STR_1703{L"Column Difinition is required",29};
public:
...
public:
	...
	constexpr static StaticUnicodeString __CNST_STR_1705{L"partition key is wrong",22};
public:
