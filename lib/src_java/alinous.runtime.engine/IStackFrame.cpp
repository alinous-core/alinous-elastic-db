...
bool IStackFrame::__init_static_variables(){
 ...
 IStackFrame::IStackFrame(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void IStackFrame::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IStackFrame::__cleanUp(ThreadContext* ctx){
}
}}}
