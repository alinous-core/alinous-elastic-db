...
String* SubStackFrame::TAG_SUB_STACKFRAME = ConstStr::getCNST_STR_1166();
String* SubStackFrame::ATTR_LINE = ConstStr::getCNST_STR_1157();
String* SubStackFrame::ATTR_FILENAME = ConstStr::getCNST_STR_1158();
