...
String* SubStackFrame::TAG_SUB_STACKFRAME = ConstStr::getCNST_STR_1167();
String* SubStackFrame::ATTR_LINE = ConstStr::getCNST_STR_1158();
String* SubStackFrame::ATTR_FILENAME = ConstStr::getCNST_STR_1159();
