...
bool ReturnStatement::__init_static_variables(){
 ...
 ReturnStatement::ReturnStatement(ThreadContext* ctx) throw()  : IObject(ctx), AbstractAlinousStatement(ctx), exp(nullptr)
{
}
void ReturnStatement::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ReturnStatement::__cleanUp(ThreadContext* ctx){
}
}}}
