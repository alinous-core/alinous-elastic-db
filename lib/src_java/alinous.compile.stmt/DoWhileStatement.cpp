...
bool DoWhileStatement::__init_static_variables(){
 ...
 DoWhileStatement::DoWhileStatement(ThreadContext* ctx) throw()  : IObject(ctx), AbstractAlinousStatement(ctx), label(nullptr), exp(nullptr), exec(nullptr)
{
}
void DoWhileStatement::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void DoWhileStatement::__cleanUp(ThreadContext* ctx){
}
}}}
