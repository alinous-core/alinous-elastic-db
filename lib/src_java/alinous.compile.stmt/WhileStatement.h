#ifndef ALINOUS_COMPILE_STMT_WHILESTATEMENT_H_
#define ALINOUS_COMPILE_STMT_WHILESTATEMENT_H_
...
class WhileStatement final : public AbstractAlinousStatement {
public:
	WhileStatement(const WhileStatement& base) = default;
public:
	WhileStatement(ThreadContext* ctx) throw()  : IObject(ctx), AbstractAlinousStatement(ctx), label(nullptr), exp(nullptr), exec(nullptr)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~WhileStatement() throw();
...
#endif /* end of ALINOUS_COMPILE_STMT_WHILESTATEMENT_H_ */
