#ifndef ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMADATA_H_
#define ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMADATA_H_
...
public:
	SchemaData(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMADATA_H_ */
