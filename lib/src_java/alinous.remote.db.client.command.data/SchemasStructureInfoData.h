#ifndef ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMASSTRUCTUREINFODATA_H_
#define ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMASSTRUCTUREINFODATA_H_
...
public:
	SchemasStructureInfoData(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_SCHEMASSTRUCTUREINFODATA_H_ */
