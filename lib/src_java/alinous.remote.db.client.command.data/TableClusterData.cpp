...
void TableClusterData::__construct_impl(String* name, String* region, ThreadContext* ctx) throw() 
{
 ...
 TableClusterData::TableClusterData(ThreadContext* ctx) throw()  : IObject(ctx), ICommandData(ctx), name(nullptr), region(nullptr), nodesList(GCUtils<ArrayList<StorageNodeData> >::ins(this, (new(ctx) ArrayList<StorageNodeData>(ctx)), ctx, __FILEW__, __LINE__, L""))
{
}
void TableClusterData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void TableClusterData::__cleanUp(ThreadContext* ctx){
}
}}}}}}
