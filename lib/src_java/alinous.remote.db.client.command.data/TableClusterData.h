#ifndef ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_TABLECLUSTERDATA_H_
#define ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_TABLECLUSTERDATA_H_
...
public:
	...
	TableClusterData(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_REMOTE_DB_CLIENT_COMMAND_DATA_TABLECLUSTERDATA_H_ */
