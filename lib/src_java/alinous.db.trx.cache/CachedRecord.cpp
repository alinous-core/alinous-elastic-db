...
void CachedRecord::setPosition(long long position, ThreadContext* ctx) throw() 
{
}
int CachedRecord::getLockMode(ThreadContext* ctx) throw() 
{
	return -1;
}
void CachedRecord::setLockMode(int lockMode, ThreadContext* ctx) throw() 
{
}
