#ifndef ALINOUS_HTML_XPATH_XPATHORSTATEMENT_H_
#define ALINOUS_HTML_XPATH_XPATHORSTATEMENT_H_
...
class XpathOrStatement final : public AbstractContainerStatement {
public:
...
#endif /* end of ALINOUS_HTML_XPATH_XPATHORSTATEMENT_H_ */
