#ifndef ALINOUS_REMOTE_REGION_COMMAND_GETSCHEMAFROMREGIONCOMMAND_H_
#define ALINOUS_REMOTE_REGION_COMMAND_GETSCHEMAFROMREGIONCOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_REGION_COMMAND_GETSCHEMAFROMREGIONCOMMAND_H_ */
