...
bool TrxLockContext::__init_static_variables(){
 ...
 TrxLockContext::TrxLockContext(ThreadContext* ctx) throw()  : IObject(ctx), map(GCUtils<Map<String,IThreadLocker> >::ins(this, (new(ctx) HashMap<String,IThreadLocker>(ctx)), ctx, __FILEW__, __LINE__, L""))
{
}
void TrxLockContext::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void TrxLockContext::__cleanUp(ThreadContext* ctx){
}
}}}
