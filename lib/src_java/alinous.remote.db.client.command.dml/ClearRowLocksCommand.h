#ifndef ALINOUS_REMOTE_DB_CLIENT_COMMAND_DML_CLEARROWLOCKSCOMMAND_H_
#define ALINOUS_REMOTE_DB_CLIENT_COMMAND_DML_CLEARROWLOCKSCOMMAND_H_
...
class ClearRowLocksCommand final : public AbstractRemoteStorageCommand {
public:
	ClearRowLocksCommand(const ClearRowLocksCommand& base) = default;
public:
	ClearRowLocksCommand(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~ClearRowLocksCommand() throw();
...
#endif /* end of ALINOUS_REMOTE_DB_CLIENT_COMMAND_DML_CLEARROWLOCKSCOMMAND_H_ */
