...
bool AndExpression::__init_static_variables(){
 ...
 AndExpression::AndExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractBooleanCollectionExpression(ctx)
{
}
void AndExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void AndExpression::__cleanUp(ThreadContext* ctx){
}
}}}}
