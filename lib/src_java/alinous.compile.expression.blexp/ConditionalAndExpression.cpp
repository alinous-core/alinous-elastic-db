...
bool ConditionalAndExpression::__init_static_variables(){
 ...
 ConditionalAndExpression::ConditionalAndExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractBooleanCollectionExpression(ctx)
{
}
void ConditionalAndExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ConditionalAndExpression::__cleanUp(ThreadContext* ctx){
}
}}}}
