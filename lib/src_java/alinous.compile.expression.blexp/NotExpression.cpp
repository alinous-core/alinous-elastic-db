...
bool NotExpression::__init_static_variables(){
 ...
 NotExpression::NotExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractBooleanExpression(ctx), exp(nullptr)
{
}
void NotExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void NotExpression::__cleanUp(ThreadContext* ctx){
}
}}}}
