...
void BooleanSubExpression::__construct_impl(String* op, IExpression* exp, ThreadContext* ctx) throw() 
{
 ...
 BooleanSubExpression::BooleanSubExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractExpression(ctx), op(0), exp(nullptr)
{
}
void BooleanSubExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void BooleanSubExpression::__cleanUp(ThreadContext* ctx){
}
}}}}
