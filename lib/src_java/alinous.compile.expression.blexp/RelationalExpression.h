#ifndef ALINOUS_COMPILE_EXPRESSION_BLEXP_RELATIONALEXPRESSION_H_
#define ALINOUS_COMPILE_EXPRESSION_BLEXP_RELATIONALEXPRESSION_H_
...
class RelationalExpression final : public AbstractBooleanExpression {
public:
	RelationalExpression(const RelationalExpression& base) = default;
public:
	RelationalExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractBooleanExpression(ctx), left(nullptr), ope(0), right(nullptr)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~RelationalExpression() throw();
...
#endif /* end of ALINOUS_COMPILE_EXPRESSION_BLEXP_RELATIONALEXPRESSION_H_ */
