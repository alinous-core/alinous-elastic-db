...
bool IDomVariable::__init_static_variables(){
 ...
 IDomVariable::IDomVariable(ThreadContext* ctx) throw()  : IObject(ctx), IDomVariableContainer(ctx), IAlinousVariable(ctx)
{
}
void IDomVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IDomVariable::__cleanUp(ThreadContext* ctx){
}
}}}
