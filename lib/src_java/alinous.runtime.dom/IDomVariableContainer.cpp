...
bool IDomVariableContainer::__init_static_variables(){
 ...
 IDomVariableContainer::IDomVariableContainer(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void IDomVariableContainer::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IDomVariableContainer::__cleanUp(ThreadContext* ctx){
}
}}}
