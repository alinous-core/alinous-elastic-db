...
String* DomVariable::VAL_TYPE = ConstStr::getCNST_STR_1113();
String* DomVariable::PROPS = ConstStr::getCNST_STR_1114();
...
{
	throw (new(ctx) RuntimeException(ConstStr::getCNST_STR_1112(), ctx));
}
