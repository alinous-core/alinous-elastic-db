...
String* DomVariable::VAL_TYPE = ConstStr::getCNST_STR_1112();
String* DomVariable::PROPS = ConstStr::getCNST_STR_1113();
...
String* DomVariable::toString(ThreadContext* ctx) throw() 
{
	...
	buff->append(ConstStr::getCNST_STR_1109(), ctx);
	int cnt = 0;
	...
	buff->append(ConstStr::getCNST_STR_1110(), ctx);
...
{
	throw (new(ctx) RuntimeException(ConstStr::getCNST_STR_1111(), ctx));
}
