#ifndef ALINOUS_RUNTIME_DOM_DOMARRAY_H_
#define ALINOUS_RUNTIME_DOM_DOMARRAY_H_
...
class DomArray final : public IDomVariable, public virtual IObject {
public:
	DomArray(const DomArray& base) = default;
public:
	DomArray(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~DomArray() throw();
	virtual void __releaseRegerences(bool prepare, ThreadContext* ctx) throw();
private:
	ArrayList<IDomVariable>* array;
	int num;
	int cap;
public:
...
public:
	...
	void put(IDomVariable* val, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_RUNTIME_DOM_DOMARRAY_H_ */
