#ifndef ALINOUS_RUNTIME_DOM_DOCUMENTVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_DOCUMENTVARIABLE_H_
...
class DocumentVariable final : public IDomVariable, public virtual IObject {
public:
	DocumentVariable(const DocumentVariable& base) = default;
public:
	DocumentVariable(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	DocumentVariable(bool array, ThreadContext* ctx) throw() ;
	void __construct_impl(bool array, ThreadContext* ctx) throw() ;
	virtual ~DocumentVariable() throw();
	virtual void __releaseRegerences(bool prepare, ThreadContext* ctx) throw();
private:
	IDomVariable* value;
public:
	void outDebugXml(DomNode* parentNode, String* name, ThreadContext* ctx) throw()  final;
	IDomVariable* getByDescriptor(DomVariableDescriptor* desc, ThreadContext* ctx) final;
	void setProperty(String* key, IDomVariable* value, ThreadContext* ctx) final;
	IDomVariableContainer* getProperty(String* key, ThreadContext* ctx) final;
...
#endif /* end of ALINOUS_RUNTIME_DOM_DOCUMENTVARIABLE_H_ */
