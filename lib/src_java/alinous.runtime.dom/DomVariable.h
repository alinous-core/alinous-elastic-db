#ifndef ALINOUS_RUNTIME_DOM_DOMVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_DOMVARIABLE_H_
...
class DomVariable final : public IDomVariable, public IDatabaseRecord, public virtual IObject {
public:
	DomVariable(const DomVariable& base) = default;
public:
	DomVariable(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	DomVariable(VariantValue* value, ThreadContext* ctx) throw() ;
	void __construct_impl(VariantValue* value, ThreadContext* ctx) throw() ;
	DomVariable(String* value, ThreadContext* ctx) throw() ;
	void __construct_impl(String* value, ThreadContext* ctx) throw() ;
	DomVariable(char value, ThreadContext* ctx) throw() ;
	void __construct_impl(char value, ThreadContext* ctx) throw() ;
	DomVariable(short value, ThreadContext* ctx) throw() ;
	void __construct_impl(short value, ThreadContext* ctx) throw() ;
	DomVariable(wchar_t value, ThreadContext* ctx) throw() ;
	void __construct_impl(wchar_t value, ThreadContext* ctx) throw() ;
	DomVariable(int value, ThreadContext* ctx) throw() ;
	void __construct_impl(int value, ThreadContext* ctx) throw() ;
	DomVariable(long long value, ThreadContext* ctx) throw() ;
	void __construct_impl(long long value, ThreadContext* ctx) throw() ;
	DomVariable(Timestamp* value, ThreadContext* ctx) throw() ;
	void __construct_impl(Timestamp* value, ThreadContext* ctx) throw() ;
	DomVariable(TimeOnlyTimestamp* value, ThreadContext* ctx) throw() ;
	void __construct_impl(TimeOnlyTimestamp* value, ThreadContext* ctx) throw() ;
	DomVariable(BigDecimal* value, ThreadContext* ctx) throw() ;
	void __construct_impl(BigDecimal* value, ThreadContext* ctx) throw() ;
	DomVariable(float value, ThreadContext* ctx) throw() ;
	void __construct_impl(float value, ThreadContext* ctx) throw() ;
	DomVariable(double value, ThreadContext* ctx) throw() ;
	void __construct_impl(double value, ThreadContext* ctx) throw() ;
	virtual ~DomVariable() throw();
	virtual void __releaseRegerences(bool prepare, ThreadContext* ctx) throw();
private:
	ArrayList<IDomVariable>* properties;
...
public:
	...
	int getValueType(ThreadContext* ctx) throw() ;
	int getIntValue(ThreadContext* ctx) final;
	String* getStringValue(ThreadContext* ctx) final;
	IDomVariable* get(String* name, ThreadContext* ctx) throw() ;
	VariantValue* getValue(ThreadContext* ctx) throw() ;
	void setValue(VariantValue* value, ThreadContext* ctx) throw() ;
	String* toString(ThreadContext* ctx) throw() ;
	IDomVariable* get(int index, ThreadContext* ctx) throw()  final;
	void setProperty(String* key, IDomVariable* value, ThreadContext* ctx) throw()  final;
	IDomVariable* getProperty(String* key, ThreadContext* ctx) throw()  final;
	Iterator<String>* getPropertiesIterator(ThreadContext* ctx) throw() ;
...
private:
	static void importProps(DomNode* node, DomVariable* parentDom, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_DOMVARIABLE_H_ */
