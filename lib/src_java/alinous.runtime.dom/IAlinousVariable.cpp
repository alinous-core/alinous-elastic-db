...
String* IAlinousVariable::ATTR_NAME = ConstStr::getCNST_STR_1122();
...
bool IAlinousVariable::__init_static_variables(){
 ...
 IAlinousVariable::IAlinousVariable(ThreadContext* ctx) throw()  : IObject(ctx), ICommandData(ctx)
{
}
void IAlinousVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IAlinousVariable::__cleanUp(ThreadContext* ctx){
}
}}}
