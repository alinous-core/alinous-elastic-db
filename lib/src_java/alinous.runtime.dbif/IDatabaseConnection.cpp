...
bool IDatabaseConnection::__init_static_variables(){
 ...
 IDatabaseConnection::IDatabaseConnection(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void IDatabaseConnection::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IDatabaseConnection::__cleanUp(ThreadContext* ctx){
}
}}}
