...
bool IDatabaseDriver::__init_static_variables(){
 ...
 IDatabaseDriver::IDatabaseDriver(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void IDatabaseDriver::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IDatabaseDriver::__cleanUp(ThreadContext* ctx){
}
}}}
