...
void HtmlXmlParser::__cleanUp(ThreadContext* ctx){
...
bool HtmlXmlParser::LookaheadSuccess::__init_static_variables(){
 ...
 HtmlXmlParser::LookaheadSuccess::LookaheadSuccess(ThreadContext* ctx) throw()  : IObject(ctx), java::lang::Error(ctx)
{
}
void HtmlXmlParser::LookaheadSuccess::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void HtmlXmlParser::LookaheadSuccess::__cleanUp(ThreadContext* ctx){
}
}}}}
...
bool HtmlXmlParser::JJCalls::__init_static_variables(){
 ...
 HtmlXmlParser::JJCalls::JJCalls(ThreadContext* ctx) throw()  : IObject(ctx), gen(0), first(nullptr), arg(0), next(nullptr)
{
}
void HtmlXmlParser::JJCalls::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void HtmlXmlParser::JJCalls::__cleanUp(ThreadContext* ctx){
}
}}}}
