#ifndef ALINOUS_WEB_PARSE_HTMLXML_JAVACHARSTREAM_H_
#define ALINOUS_WEB_PARSE_HTMLXML_JAVACHARSTREAM_H_
...
#endif /* end of ALINOUS_WEB_PARSE_HTMLXML_JAVACHARSTREAM_H_ */
