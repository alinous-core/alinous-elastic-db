...
{
	return (ConstStr::getCNST_STR_1240()->clone(ctx)->append(errorLine, ctx)->append(ConstStr::getCNST_STR_1241(), ctx)->append(errorColumn, ctx)->append(ConstStr::getCNST_STR_1242(), ctx)->append((EOFSeen ? ConstStr::getCNST_STR_1243() : (ConstStr::getCNST_STR_1244()->clone(ctx)->append(addEscapes(String::valueOf(curChar, ctx), ctx), ctx)->append(ConstStr::getCNST_STR_1244(), ctx))->clone(ctx)->append(ConstStr::getCNST_STR_887(), ctx)->append(((int)curChar), ctx)->append(ConstStr::getCNST_STR_1245(), ctx)), ctx)->append(ConstStr::getCNST_STR_1246(), ctx)->append(addEscapes(errorAfter, ctx), ctx)->append(ConstStr::getCNST_STR_1244(), ctx));
}
}}}}
