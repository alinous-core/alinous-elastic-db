#ifndef ALINOUS_REMOTE_REGION_SERVER_SCAN_EQKEYSCANWORKER_H_
#define ALINOUS_REMOTE_REGION_SERVER_SCAN_EQKEYSCANWORKER_H_
...
class EqKeyScanWorker final : public IScanWorker, public virtual IObject {
public:
...
#endif /* end of ALINOUS_REMOTE_REGION_SERVER_SCAN_EQKEYSCANWORKER_H_ */
