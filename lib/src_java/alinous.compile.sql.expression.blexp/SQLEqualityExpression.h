#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLEQUALITYEXPRESSION_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLEQUALITYEXPRESSION_H_
...
class SQLEqualityExpression final : public AbstractSQLBooleanExpression {
public:
...
public:
	...
	bool isCheckEquals(ThreadContext* ctx) throw() ;
	void setCheckEquals(bool checkEquals, ThreadContext* ctx) throw() ;
	void setCheckEquals(String* strEq, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLEQUALITYEXPRESSION_H_ */
