#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLISNULLEXPRESSION_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLISNULLEXPRESSION_H_
...
class SQLIsNullExpression final : public AbstractSQLBooleanExpression {
public:
	SQLIsNullExpression(const SQLIsNullExpression& base) = default;
public:
	SQLIsNullExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractSQLBooleanExpression(ctx), first(nullptr), notNull(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~SQLIsNullExpression() throw();
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLISNULLEXPRESSION_H_ */
