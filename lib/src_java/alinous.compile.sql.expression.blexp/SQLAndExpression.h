#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLANDEXPRESSION_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLANDEXPRESSION_H_
...
class SQLAndExpression final : public AbstractSQLBooleanCollectionExpression {
public:
	SQLAndExpression(const SQLAndExpression& base) = default;
public:
	SQLAndExpression(ArrayList<ISQLExpression>* result, ThreadContext* ctx) throw() ;
	void __construct_impl(ArrayList<ISQLExpression>* result, ThreadContext* ctx) throw() ;
	SQLAndExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractSQLBooleanCollectionExpression(ctx)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~SQLAndExpression() throw();
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLANDEXPRESSION_H_ */
