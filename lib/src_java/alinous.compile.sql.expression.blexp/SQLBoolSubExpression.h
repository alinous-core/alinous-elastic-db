#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLSUBEXPRESSION_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLSUBEXPRESSION_H_
...
class SQLBoolSubExpression final : public AbstractSQLBooleanExpression {
public:
	SQLBoolSubExpression(const SQLBoolSubExpression& base) = default;
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLSUBEXPRESSION_H_ */
