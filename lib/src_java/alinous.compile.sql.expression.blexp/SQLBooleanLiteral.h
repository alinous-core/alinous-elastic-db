#ifndef ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLEANLITERAL_H_
#define ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLEANLITERAL_H_
...
class SQLBooleanLiteral final : public AbstractSQLBooleanExpression {
public:
	SQLBooleanLiteral(const SQLBooleanLiteral& base) = default;
public:
	SQLBooleanLiteral(ThreadContext* ctx) throw()  : IObject(ctx), AbstractSQLBooleanExpression(ctx), value(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~SQLBooleanLiteral() throw();
...
public:
	...
	bool isValue(ThreadContext* ctx) throw() ;
	void setValue(bool value, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_COMPILE_SQL_EXPRESSION_BLEXP_SQLBOOLEANLITERAL_H_ */
