#ifndef ALINOUS_BTREEMEMORY_SCAN_MEMORYMAXNODEITERATOR_H_
#define ALINOUS_BTREEMEMORY_SCAN_MEMORYMAXNODEITERATOR_H_
...
using ::alinous::btreememory::MBTreeMaxNode;
using ::alinous::runtime::dom::VariableException;



class MemoryMaxNodeIterator final : public INodeIterator, public virtual IObject {
public:
	MemoryMaxNodeIterator(const MemoryMaxNodeIterator& base) = default;
public:
	MemoryMaxNodeIterator(bool endStart, MBTreeMaxNode* node, ThreadContext* ctx) throw() ;
	void __construct_impl(bool endStart, MBTreeMaxNode* node, ThreadContext* ctx) throw() ;
	virtual ~MemoryMaxNodeIterator() throw();
...
#endif /* end of ALINOUS_BTREEMEMORY_SCAN_MEMORYMAXNODEITERATOR_H_ */
