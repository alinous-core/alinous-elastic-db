...
{
	context->addStaticString(ConstStr::getCNST_STR_1233(), ctx);
...
String* XHtmlDqString::toString(ThreadContext* ctx) throw() 
{
	...
	{
		buff->append(ConstStr::getCNST_STR_1233(), ctx)->append(this->value->toString(ctx), ctx)->append(ConstStr::getCNST_STR_1233(), ctx);
	}
