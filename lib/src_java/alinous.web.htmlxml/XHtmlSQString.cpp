...
{
	context->addStaticString(ConstStr::getCNST_STR_1729(), ctx);
...
String* XHtmlSQString::toString(ThreadContext* ctx) throw() 
{
	...
	{
		buff->append(ConstStr::getCNST_STR_1729(), ctx)->append(this->value->toString(ctx), ctx)->append(ConstStr::getCNST_STR_1729(), ctx);
	}
