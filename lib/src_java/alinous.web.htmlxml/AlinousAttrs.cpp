...
String* AlinousAttrs::ALINOUS_IF = ConstStr::getCNST_STR_1848();
String* AlinousAttrs::ALINOUS_INNER = ConstStr::getCNST_STR_1849();
String* AlinousAttrs::ALINOUS_TAGID = ConstStr::getCNST_STR_1850();
String* AlinousAttrs::ALINOUS_TARGET = ConstStr::getCNST_STR_1851();
String* AlinousAttrs::ALINOUS_ITERATE = ConstStr::getCNST_STR_1852();
String* AlinousAttrs::ALINOUS_VARIABLE = ConstStr::getCNST_STR_1853();
String* AlinousAttrs::ALINOUS_MSG = ConstStr::getCNST_STR_1854();
String* AlinousAttrs::ALINOUS_MSG_TARGET = ConstStr::getCNST_STR_1855();
String* AlinousAttrs::ALINOUS_FORM = ConstStr::getCNST_STR_1856();
String* AlinousAttrs::ALINOUS_BACK = ConstStr::getCNST_STR_1857();
String* AlinousAttrs::ALINOUS_VALIDATE_TYPE = ConstStr::getCNST_STR_1858();
String* AlinousAttrs::ALINOUS_VALIDATE_IF = ConstStr::getCNST_STR_1859();
String* AlinousAttrs::ALINOUS_REGEX = ConstStr::getCNST_STR_1860();
String* AlinousAttrs::ALINOUS_PARAM = ConstStr::getCNST_STR_1861();
String* AlinousAttrs::ALINOUS_TYPE = ConstStr::getCNST_STR_1862();
String* AlinousAttrs::ALINOUS_NO_FORM_CACHE = ConstStr::getCNST_STR_1863();
String* AlinousAttrs::ALINOUS_IGNOREBLANK = ConstStr::getCNST_STR_1864();
String* AlinousAttrs::ALINOUS_IGNORE_SELF_ITERATE = ConstStr::getCNST_STR_1865();
String* AlinousAttrs::ALINOUS_EXTRACT = ConstStr::getCNST_STR_1866();
String* AlinousAttrs::ALINOUS_COMPONENT = ConstStr::getCNST_STR_1867();
String* AlinousAttrs::ALINOUS_COMPONENT_ID = ConstStr::getCNST_STR_1868();
String* AlinousAttrs::ALINOUS_COMPONENT_WIDTH = ConstStr::getCNST_STR_1869();
String* AlinousAttrs::ALINOUS_COMPONENT_EDIT = ConstStr::getCNST_STR_1870();
String* AlinousAttrs::ALINOUS_COMPONENT_VIEW = ConstStr::getCNST_STR_1871();
String* AlinousAttrs::ALINOUS_COMPONENT_VIEWTYPE = ConstStr::getCNST_STR_1872();
String* AlinousAttrs::ALINOUS_COMPONENT_ROOT = ConstStr::getCNST_STR_1873();
String* AlinousAttrs::VALUE_TRUE = ConstStr::getCNST_STR_372();
String* AlinousAttrs::VALUE_FALSE = ConstStr::getCNST_STR_989();
String* AlinousAttrs::VALUE_VIEWTYPE_FRAME = ConstStr::getCNST_STR_1874();
String* AlinousAttrs::VALUE_VIEWTYPE_INNER = ConstStr::getCNST_STR_1875();
String* AlinousAttrs::ALINOUS_ALINOUS_FORM = ConstStr::getCNST_STR_1876();
