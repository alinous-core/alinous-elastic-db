#ifndef ALINOUS_WEB_HTMLXML_XHTMLDQSTRING_H_
#define ALINOUS_WEB_HTMLXML_XHTMLDQSTRING_H_
...
using ::alinous::web::htmlxml::module::DynamicExecutableAttributeValue;
using ::alinous::web::htmlxml::module::SerializeContext;



class XHtmlDqString final : public AbstractXHtmlAttributeValue {
public:
...
public:
	void initDinamicProgram(ThreadContext* ctx);
...
#endif /* end of ALINOUS_WEB_HTMLXML_XHTMLDQSTRING_H_ */
