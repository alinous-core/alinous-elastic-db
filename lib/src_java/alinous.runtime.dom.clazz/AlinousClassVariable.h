#ifndef ALINOUS_RUNTIME_DOM_CLAZZ_ALINOUSCLASSVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_CLAZZ_ALINOUSCLASSVARIABLE_H_
...
class AlinousClassVariable final : public IAlinousClassVariable, public virtual IObject {
public:
	AlinousClassVariable(const AlinousClassVariable& base) = default;
public:
...
private:
	HashMap<String,IAlinousVariable>* memberValues;
	AlinousClass* classDeclare;
	bool nullObject;
public:
...
public:
	void outDebugXml(DomNode* parentNode, String* nm, ThreadContext* ctx) throw()  final;
	AlinousClass* getClassDeclare(ThreadContext* ctx) throw() ;
	void setMemberVariable(String* name, IAlinousVariable* variable, ThreadContext* ctx) throw() ;
	IAlinousVariable* getMemberVariable(String* name, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_RUNTIME_DOM_CLAZZ_ALINOUSCLASSVARIABLE_H_ */
