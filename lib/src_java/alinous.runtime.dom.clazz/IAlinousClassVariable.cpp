...
bool IAlinousClassVariable::__init_static_variables(){
 ...
 IAlinousClassVariable::IAlinousClassVariable(ThreadContext* ctx) throw()  : IObject(ctx), ITypedVariable(ctx)
{
}
void IAlinousClassVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IAlinousClassVariable::__cleanUp(ThreadContext* ctx){
}
}}}}
