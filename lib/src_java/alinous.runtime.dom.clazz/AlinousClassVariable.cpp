...
String* AlinousClassVariable::CLASS_VARIABLE = ConstStr::getCNST_STR_1123();
String* AlinousClassVariable::CLASS_TYPE = ConstStr::getCNST_STR_1124();
String* AlinousClassVariable::MEMBERS = ConstStr::getCNST_STR_1123();
