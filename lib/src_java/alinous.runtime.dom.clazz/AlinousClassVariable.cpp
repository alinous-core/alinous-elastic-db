...
String* AlinousClassVariable::CLASS_VARIABLE = ConstStr::getCNST_STR_1117();
String* AlinousClassVariable::CLASS_TYPE = ConstStr::getCNST_STR_1118();
String* AlinousClassVariable::MEMBERS = ConstStr::getCNST_STR_1117();
...
String* AlinousClassVariable::toString(ThreadContext* ctx) throw() 
{
	...
	while(it->hasNext(ctx))
	{
		...
		buff->append(key, ctx)->append(ConstStr::getCNST_STR_1073(), ctx);
		if(val != nullptr)
		{
