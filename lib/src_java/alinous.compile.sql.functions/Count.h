#ifndef ALINOUS_COMPILE_SQL_FUNCTIONS_COUNT_H_
#define ALINOUS_COMPILE_SQL_FUNCTIONS_COUNT_H_
...
class Count final : public ISQLFunctionBody, public virtual IObject {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_FUNCTIONS_COUNT_H_ */
