...
String* DebugThread::TAG_THREAD = ConstStr::getCNST_STR_1276();
String* DebugThread::ATTR_THREAD_ID = ConstStr::getCNST_STR_1277();
String* DebugThread::ATTR_STATUS = ConstStr::getCNST_STR_1278();
