...
String* DebugThread::TAG_THREAD = ConstStr::getCNST_STR_1170();
String* DebugThread::ATTR_THREAD_ID = ConstStr::getCNST_STR_1171();
String* DebugThread::ATTR_STATUS = ConstStr::getCNST_STR_1172();
