...
String* DebugThread::TAG_THREAD = ConstStr::getCNST_STR_1168();
String* DebugThread::ATTR_THREAD_ID = ConstStr::getCNST_STR_1169();
String* DebugThread::ATTR_STATUS = ConstStr::getCNST_STR_1170();
