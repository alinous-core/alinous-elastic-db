...
String* DebugThread::TAG_THREAD = ConstStr::getCNST_STR_1165();
String* DebugThread::ATTR_THREAD_ID = ConstStr::getCNST_STR_1166();
String* DebugThread::ATTR_STATUS = ConstStr::getCNST_STR_1167();
