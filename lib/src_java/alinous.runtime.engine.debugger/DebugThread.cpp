...
String* DebugThread::TAG_THREAD = ConstStr::getCNST_STR_1114();
String* DebugThread::ATTR_THREAD_ID = ConstStr::getCNST_STR_1115();
String* DebugThread::ATTR_STATUS = ConstStr::getCNST_STR_1116();
