...
inline static void __cleanUpStatics(alinous::ThreadContext* ctx){
	...
	alinous::remote::region::client::TableAccessStatusListner::__cleanUp(ctx);
	...
	alinous::remote::region::client::command::NodeRegionCommandReader::__cleanUp(ctx);
	alinous::remote::region::client::command::AbstractNodeRegionCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::NodeRegionVoidCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::GetSchemaFromRegionCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::NodeRegionFinishConnectionCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::NodeRegionConnectCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::NodeRegionTerminateCommand::__cleanUp(ctx);
	alinous::remote::region::client::command::data::ClientStructureMetadata::__cleanUp(ctx);
	...
	alinous::remote::region::client::command::dml::ClientClearSelectSessionCommand::__cleanUp(ctx);
	...
	alinous::remote::region::server::schema::strategy::UniqueOpValue::__cleanUp(ctx);
