...
bool ITableSchema::__init_static_variables(){
 ...
 ITableSchema::ITableSchema(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void ITableSchema::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ITableSchema::__cleanUp(ThreadContext* ctx){
}
}}
