...
void AlinousDatabase::construct(AlinousCore* core, String* dataDir, String* trxTmpDir, int maxConnection, ThreadContext* ctx)
{
	...
	__GC_MV(this, &(this->workerThreadsPool), (new(ctx) ThreadPool(16, ConstStr::getCNST_STR_1653(), ctx)), ThreadPool);
	...
	File* file = getConfigFile(ctx);
	{
		...
		{
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1654(), e, ctx));
		}
...
void AlinousDatabase::initInstance(AlinousDbInstanceInfo* instanceConfig, ThreadContext* ctx)
{
	...
	schemas->createSchema(ConstStr::getCNST_STR_955(), ctx);
	{
		...
		catch(IOException* e)
		{
			...
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1655(), e, ctx));
		}
		catch(InterruptedException* e)
		{
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1655(), e, ctx));
...
{
	{
		...
		{
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1656(), e, ctx));
		}
	}
}
...
void AlinousDatabase::open(AlinousDbInstanceInfo* instanceConfig, ThreadContext* ctx)
{
	...
	__GC_MV(this, &(this->trxWriterThread), (new(ctx) AlinousThread(trxLaunchJoin, ctx)), AlinousThread);
	{
		...
		catch(InterruptedException* e)
		{
			...
			__GC_MV(this, &(this->workerThreadsPool), nullptr, ThreadPool);
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1660(), e, ctx));
		}
	}
		...
		{
			{
				...
				{
					throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1661(), e2, ctx));
				}
				catch(InterruptedException* e2)
				{
					throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1661(), e2, ctx));
			...
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1661(), e, ctx));
		}
	}
	{
		try
	...
	}
	{
		...
		{
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1662(), e, ctx));
		}
		catch(IOException* e)
		{
			throw (new(ctx) AlinousDbException(ConstStr::getCNST_STR_1662(), e, ctx));
...
File* AlinousDatabase::getConfigFile(ThreadContext* ctx) throw() 
{
	...
	{
		String* pathname = this->dataDir->clone(ctx)->append(ConstStr::getCNST_STR_1659(), ctx);
