...
{
	return ConstStr::getCNST_STR_1683();
}
...
void LocalTableRegion::includes(ITableSchema* arg0, ThreadContext* ctx) throw() 
{
}
void LocalTableRegion::__cleanUp(ThreadContext* ctx){
}
}}
