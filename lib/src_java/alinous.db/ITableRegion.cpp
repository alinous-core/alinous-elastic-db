...
bool ITableRegion::__init_static_variables(){
 ...
 ITableRegion::ITableRegion(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void ITableRegion::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ITableRegion::__cleanUp(ThreadContext* ctx){
}
}}
