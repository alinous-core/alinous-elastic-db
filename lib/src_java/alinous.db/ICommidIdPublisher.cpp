...
bool ICommidIdPublisher::__init_static_variables(){
 ...
 ICommidIdPublisher::ICommidIdPublisher(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void ICommidIdPublisher::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ICommidIdPublisher::__cleanUp(ThreadContext* ctx){
}
}}
