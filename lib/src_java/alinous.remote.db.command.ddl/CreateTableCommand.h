#ifndef ALINOUS_REMOTE_DB_COMMAND_DDL_CREATETABLECOMMAND_H_
#define ALINOUS_REMOTE_DB_COMMAND_DDL_CREATETABLECOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_DB_COMMAND_DDL_CREATETABLECOMMAND_H_ */
