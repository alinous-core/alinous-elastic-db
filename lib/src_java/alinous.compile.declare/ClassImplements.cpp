...
bool ClassImplements::__init_static_variables(){
 ...
 ClassImplements::ClassImplements(ThreadContext* ctx) throw()  : IObject(ctx), IDeclare(ctx), className(nullptr), analysedClazz(nullptr)
{
}
void ClassImplements::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ClassImplements::readData(NetworkBinaryBuffer* buff, ThreadContext* ctx)
{
...
void ClassImplements::writeData(NetworkBinaryBuffer* buff, ThreadContext* ctx) throw() 
{
	buff->putInt(ICommandData::__ClassImplements, ctx);
...
void ClassImplements::__cleanUp(ThreadContext* ctx){
}
}}}
