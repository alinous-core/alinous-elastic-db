...
class RemoteClientReadCommittedTrx final : public DbTransaction {
public:
	RemoteClientReadCommittedTrx(const RemoteClientReadCommittedTrx& base) = default;
public:
	RemoteClientReadCommittedTrx(DbTransactionManager* mgr, String* tmpDir, AlinousDatabase* database, AlinousCore* core, long long commitId, ThreadContext* ctx) throw() ;
