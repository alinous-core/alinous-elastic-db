...
int RemoteClientReadCommittedTrx::getIsolationLevel(ThreadContext* ctx) throw() 
{
	return IDatabaseDriver::READ_COMMITTED;
}
void RemoteClientReadCommittedTrx::__cleanUp(ThreadContext* ctx){
}
}}}}}
