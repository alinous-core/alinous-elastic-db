...
bool IBTreeKey::__init_static_variables(){
 ...
 IBTreeKey::IBTreeKey(ThreadContext* ctx) throw()  : IObject(ctx), Comparable<IBTreeKey>(ctx)
{
}
void IBTreeKey::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IBTreeKey::__cleanUp(ThreadContext* ctx){
}
}}
