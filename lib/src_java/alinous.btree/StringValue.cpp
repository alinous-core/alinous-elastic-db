...
bool StringValue::ValueFetcher::__init_static_variables(){
 ...
 StringValue::ValueFetcher::ValueFetcher(ThreadContext* ctx) throw()  : IObject(ctx), IValueFetcher(ctx)
{
}
void StringValue::ValueFetcher::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void StringValue::ValueFetcher::__cleanUp(ThreadContext* ctx){
}
}}
