...
bool IValueFetcher::__init_static_variables(){
 ...
 IValueFetcher::IValueFetcher(ThreadContext* ctx) throw()  : IObject(ctx)
{
}
void IValueFetcher::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IValueFetcher::__cleanUp(ThreadContext* ctx){
}
}}
