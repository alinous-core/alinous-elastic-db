...
void IntValue::__cleanUp(ThreadContext* ctx){
}
}}
...
bool IntValue::ValueFetcher::__init_static_variables(){
 ...
 IntValue::ValueFetcher::ValueFetcher(ThreadContext* ctx) throw()  : IObject(ctx), IValueFetcher(ctx)
{
}
void IntValue::ValueFetcher::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void IntValue::ValueFetcher::__cleanUp(ThreadContext* ctx){
}
}}
