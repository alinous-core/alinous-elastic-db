#ifndef ALINOUS_REMOTE_REGION_COMMAND_DDL_REGIONCREATESCHEMACOMMAND_H_
#define ALINOUS_REMOTE_REGION_COMMAND_DDL_REGIONCREATESCHEMACOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_REGION_COMMAND_DDL_REGIONCREATESCHEMACOMMAND_H_ */
