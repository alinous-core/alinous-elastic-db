...
{
	return (ConstStr::getCNST_STR_1243()->clone(ctx)->append(errorLine, ctx)->append(ConstStr::getCNST_STR_1244(), ctx)->append(errorColumn, ctx)->append(ConstStr::getCNST_STR_1245(), ctx)->append((EOFSeen ? ConstStr::getCNST_STR_1246() : (ConstStr::getCNST_STR_1247()->clone(ctx)->append(addEscapes(String::valueOf(curChar, ctx), ctx), ctx)->append(ConstStr::getCNST_STR_1247(), ctx))->clone(ctx)->append(ConstStr::getCNST_STR_887(), ctx)->append(((int)curChar), ctx)->append(ConstStr::getCNST_STR_1248(), ctx)), ctx)->append(ConstStr::getCNST_STR_1249(), ctx)->append(addEscapes(errorAfter, ctx), ctx)->append(ConstStr::getCNST_STR_1247(), ctx));
}
}}}
