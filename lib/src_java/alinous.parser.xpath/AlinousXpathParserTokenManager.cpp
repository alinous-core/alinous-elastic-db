...
const StaticArrayObject<UnicodeStringWrapper> AlinousXpathParserTokenManager::__lexStateNames = {ConstStr::getCNST_STR_1541(), ConstStr::getCNST_STR_1687(), ConstStr::getCNST_STR_1688()};
...
void AlinousXpathParserTokenManager::TokenLexicalActions(Token* matchedToken, ThreadContext* ctx)
{
	...
	case 54:
		...
		__GC_MV(matchedToken, &(matchedToken->image), img->replaceAll(ConstStr::getCNST_STR_1686(), ConstStr::getCNST_STR_1646(), ctx), String);
		break ;
		}
	default:
		break ;
