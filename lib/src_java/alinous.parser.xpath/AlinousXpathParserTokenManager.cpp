...
const StaticArrayObject<UnicodeStringWrapper> AlinousXpathParserTokenManager::__lexStateNames = {ConstStr::getCNST_STR_1569(), ConstStr::getCNST_STR_1718(), ConstStr::getCNST_STR_1719()};
...
void AlinousXpathParserTokenManager::TokenLexicalActions(Token* matchedToken, ThreadContext* ctx)
{
	...
	case 54:
		...
		__GC_MV(matchedToken, &(matchedToken->image), img->replaceAll(ConstStr::getCNST_STR_1717(), ConstStr::getCNST_STR_1677(), ctx), String);
		break ;
		}
	default:
		break ;
