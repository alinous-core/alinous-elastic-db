...
const StaticArrayObject<UnicodeStringWrapper> AlinousXpathParserTokenManager::__lexStateNames = {ConstStr::getCNST_STR_1569(), ConstStr::getCNST_STR_1716(), ConstStr::getCNST_STR_1717()};
...
void AlinousXpathParserTokenManager::TokenLexicalActions(Token* matchedToken, ThreadContext* ctx)
{
	...
	case 54:
		...
		__GC_MV(matchedToken, &(matchedToken->image), img->replaceAll(ConstStr::getCNST_STR_1715(), ConstStr::getCNST_STR_1675(), ctx), String);
		break ;
		}
	default:
		break ;
