...
const StaticArrayObject<UnicodeStringWrapper> AlinousXpathParserTokenManager::__lexStateNames = {ConstStr::getCNST_STR_1644(), ConstStr::getCNST_STR_1803(), ConstStr::getCNST_STR_1804()};
...
void AlinousXpathParserTokenManager::TokenLexicalActions(Token* matchedToken, ThreadContext* ctx)
{
	...
	case 54:
		...
		__GC_MV(matchedToken, &(matchedToken->image), img->replaceAll(ConstStr::getCNST_STR_1802(), ConstStr::getCNST_STR_1762(), ctx), String);
		break ;
		}
	default:
		break ;
