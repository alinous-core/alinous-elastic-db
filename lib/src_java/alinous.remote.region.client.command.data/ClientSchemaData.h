#ifndef ALINOUS_REMOTE_REGION_CLIENT_COMMAND_DATA_CLIENTSCHEMADATA_H_
#define ALINOUS_REMOTE_REGION_CLIENT_COMMAND_DATA_CLIENTSCHEMADATA_H_
...
public:
	ClientSchemaData(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_REMOTE_REGION_CLIENT_COMMAND_DATA_CLIENTSCHEMADATA_H_ */
