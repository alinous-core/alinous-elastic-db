#ifndef ALINOUS_RUNTIME_DOM_TYPED_TIMESTAMPVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_TIMESTAMPVARIABLE_H_
...
class TimestampVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	Timestamp* getValue(ThreadContext* ctx) throw() ;
	void setValue(Timestamp* value, ThreadContext* ctx) throw() ;
...
public:
	static TimestampVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_TIMESTAMPVARIABLE_H_ */
