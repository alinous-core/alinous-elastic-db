#ifndef ALINOUS_RUNTIME_DOM_TYPED_STRINGVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_STRINGVARIABLE_H_
...
class StringVariable final : public AbstractTypedVariable {
public:
...
public:
	static StringVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_STRINGVARIABLE_H_ */
