...
String* CharVariable::VAL_TYPE = ConstStr::getCNST_STR_1211();
...
bool CharVariable::__init_static_variables(){
 ...
 CharVariable::CharVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void CharVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void CharVariable::__cleanUp(ThreadContext* ctx){
}
