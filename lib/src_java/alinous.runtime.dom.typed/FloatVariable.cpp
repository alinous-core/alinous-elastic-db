...
String* FloatVariable::VAL_TYPE = ConstStr::getCNST_STR_1224();
...
bool FloatVariable::__init_static_variables(){
 ...
 FloatVariable::FloatVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void FloatVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void FloatVariable::__cleanUp(ThreadContext* ctx){
}
