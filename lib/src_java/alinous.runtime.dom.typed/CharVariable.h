#ifndef ALINOUS_RUNTIME_DOM_TYPED_CHARVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_CHARVARIABLE_H_
...
class CharVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	wchar_t getValue(ThreadContext* ctx) throw() ;
	void setValue(wchar_t value, ThreadContext* ctx) throw() ;
...
public:
	static CharVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_CHARVARIABLE_H_ */
