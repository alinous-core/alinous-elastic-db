...
String* BoolVariable::VAL_TYPE = ConstStr::getCNST_STR_1082();
...
{
	String* ret = this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_1081();
	return ret;
}
...
{
	return (new(ctx) StringVariable(this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_1081(), ctx));
}
