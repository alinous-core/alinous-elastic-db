...
String* BoolVariable::VAL_TYPE = ConstStr::getCNST_STR_1213();
...
{
	String* ret = this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_989();
	return ret;
}
...
{
	return (new(ctx) StringVariable(this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_989(), ctx));
}
