...
String* BoolVariable::VAL_TYPE = ConstStr::getCNST_STR_1133();
...
{
	String* ret = this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_1132();
	return ret;
}
...
{
	return (new(ctx) StringVariable(this->value ? ConstStr::getCNST_STR_372() : ConstStr::getCNST_STR_1132(), ctx));
}
