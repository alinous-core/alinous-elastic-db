#ifndef ALINOUS_RUNTIME_DOM_TYPED_DOUBLEVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_DOUBLEVARIABLE_H_
...
class DoubleVariable final : public AbstractTypedVariable {
public:
	DoubleVariable(const DoubleVariable& base) = default;
public:
	DoubleVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	DoubleVariable(double value, ThreadContext* ctx) throw() ;
	void __construct_impl(double value, ThreadContext* ctx) throw() ;
	virtual ~DoubleVariable() throw();
...
public:
	...
	void setValue(double value, ThreadContext* ctx) throw() ;
...
public:
	static DoubleVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_DOUBLEVARIABLE_H_ */
