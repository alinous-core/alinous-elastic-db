...
String* ShortVariable::VAL_TYPE = ConstStr::getCNST_STR_1149();
...
bool ShortVariable::__init_static_variables(){
 ...
 ShortVariable::ShortVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void ShortVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ShortVariable::__cleanUp(ThreadContext* ctx){
}
