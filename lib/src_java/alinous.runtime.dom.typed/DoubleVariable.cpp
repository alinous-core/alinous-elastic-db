...
String* DoubleVariable::VAL_TYPE = ConstStr::getCNST_STR_1212();
...
bool DoubleVariable::__init_static_variables(){
 ...
 DoubleVariable::DoubleVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void DoubleVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void DoubleVariable::__cleanUp(ThreadContext* ctx){
}
