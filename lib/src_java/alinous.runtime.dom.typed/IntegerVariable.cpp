...
String* IntegerVariable::VAL_TYPE = ConstStr::getCNST_STR_1091();
...
{
	throw (new(ctx) VariableException(ConstStr::getCNST_STR_1076(), ctx));
}
...
{
	throw (new(ctx) VariableException(ConstStr::getCNST_STR_1077(), ctx));
}
