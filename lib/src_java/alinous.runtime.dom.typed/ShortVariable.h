#ifndef ALINOUS_RUNTIME_DOM_TYPED_SHORTVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_SHORTVARIABLE_H_
...
class ShortVariable final : public AbstractTypedVariable {
public:
	ShortVariable(const ShortVariable& base) = default;
public:
	ShortVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	ShortVariable(short value, ThreadContext* ctx) throw() ;
	void __construct_impl(short value, ThreadContext* ctx) throw() ;
	virtual ~ShortVariable() throw();
...
public:
	...
	short getValue(ThreadContext* ctx) throw() ;
	void setValue(short value, ThreadContext* ctx) throw() ;
...
public:
	static ShortVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_SHORTVARIABLE_H_ */
