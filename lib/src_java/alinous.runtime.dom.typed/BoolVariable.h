#ifndef ALINOUS_RUNTIME_DOM_TYPED_BOOLVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_BOOLVARIABLE_H_
...
class BoolVariable final : public AbstractTypedVariable {
public:
...
public:
	static BoolVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_BOOLVARIABLE_H_ */
