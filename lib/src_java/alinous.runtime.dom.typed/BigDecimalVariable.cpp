...
String* BigDecimalVariable::VAL_TYPE = ConstStr::getCNST_STR_1158();
...
bool BigDecimalVariable::__init_static_variables(){
 ...
 BigDecimalVariable::BigDecimalVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(nullptr)
{
}
void BigDecimalVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
{
	throw (new(ctx) VariableException(ConstStr::getCNST_STR_1157(), ctx));
}
...
void BigDecimalVariable::__cleanUp(ThreadContext* ctx){
}
