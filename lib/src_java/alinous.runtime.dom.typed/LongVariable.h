#ifndef ALINOUS_RUNTIME_DOM_TYPED_LONGVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_LONGVARIABLE_H_
...
class LongVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	void setValue(long long value, ThreadContext* ctx) throw() ;
...
public:
	static LongVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_LONGVARIABLE_H_ */
