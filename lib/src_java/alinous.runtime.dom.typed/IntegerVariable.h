#ifndef ALINOUS_RUNTIME_DOM_TYPED_INTEGERVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_INTEGERVARIABLE_H_
...
class IntegerVariable final : public AbstractTypedVariable {
public:
	IntegerVariable(const IntegerVariable& base) = default;
public:
	IntegerVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	IntegerVariable(int value, ThreadContext* ctx) throw() ;
	void __construct_impl(int value, ThreadContext* ctx) throw() ;
	virtual ~IntegerVariable() throw();
...
public:
	...
	void setValue(int value, ThreadContext* ctx) throw() ;
...
public:
	static IntegerVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_INTEGERVARIABLE_H_ */
