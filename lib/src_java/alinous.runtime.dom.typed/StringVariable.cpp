...
String* StringVariable::VAL_TYPE = ConstStr::getCNST_STR_1157();
...
BoolVariable* StringVariable::toBoolVariable(ThreadContext* ctx)
{
	...
	{
		if(this->value->equalsIgnoreCase(ConstStr::getCNST_STR_1139(), ctx))
		{
...
{
	{
		...
		{
			throw (new(ctx) VariableException(ConstStr::getCNST_STR_1156(), e, ctx));
		}
	}
}
