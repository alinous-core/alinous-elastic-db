...
String* StringVariable::VAL_TYPE = ConstStr::getCNST_STR_1153();
...
BoolVariable* StringVariable::toBoolVariable(ThreadContext* ctx)
{
	...
	{
		if(this->value->equalsIgnoreCase(ConstStr::getCNST_STR_1135(), ctx))
		{
...
{
	{
		...
		{
			throw (new(ctx) VariableException(ConstStr::getCNST_STR_1152(), e, ctx));
		}
	}
}
