...
String* StringVariable::VAL_TYPE = ConstStr::getCNST_STR_1099();
...
BoolVariable* StringVariable::toBoolVariable(ThreadContext* ctx)
{
	...
	{
		if(this->value->equalsIgnoreCase(ConstStr::getCNST_STR_1081(), ctx))
		{
...
{
	{
		...
		{
			throw (new(ctx) VariableException(ConstStr::getCNST_STR_1098(), e, ctx));
		}
	}
}
