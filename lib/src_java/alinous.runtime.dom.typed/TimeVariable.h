#ifndef ALINOUS_RUNTIME_DOM_TYPED_TIMEVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_TIMEVARIABLE_H_
...
class TimeVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	TimeOnlyTimestamp* getValue(ThreadContext* ctx) throw() ;
	void setValue(TimeOnlyTimestamp* value, ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_TIMEVARIABLE_H_ */
