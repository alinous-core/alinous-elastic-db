...
String* ByteVariable::VAL_TYPE = ConstStr::getCNST_STR_1221();
...
bool ByteVariable::__init_static_variables(){
 ...
 ByteVariable::ByteVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void ByteVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ByteVariable::__cleanUp(ThreadContext* ctx){
}
