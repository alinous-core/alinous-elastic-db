#ifndef ALINOUS_RUNTIME_DOM_TYPED_BIGDECIMALVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_BIGDECIMALVARIABLE_H_
...
class BigDecimalVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	BigDecimal* getValue(ThreadContext* ctx) throw() ;
...
public:
	static BigDecimalVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_BIGDECIMALVARIABLE_H_ */
