#ifndef ALINOUS_RUNTIME_DOM_TYPED_BYTEVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_BYTEVARIABLE_H_
...
class ByteVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	char getValue(ThreadContext* ctx) throw() ;
	void setValue(char value, ThreadContext* ctx) throw() ;
...
public:
	static ByteVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_BYTEVARIABLE_H_ */
