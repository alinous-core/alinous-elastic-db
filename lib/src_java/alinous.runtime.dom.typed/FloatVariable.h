#ifndef ALINOUS_RUNTIME_DOM_TYPED_FLOATVARIABLE_H_
#define ALINOUS_RUNTIME_DOM_TYPED_FLOATVARIABLE_H_
...
class FloatVariable final : public AbstractTypedVariable {
public:
...
public:
	...
	float getValue(ThreadContext* ctx) throw() ;
	void setValue(float value, ThreadContext* ctx) throw() ;
...
public:
	static FloatVariable* fromDebugXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_DOM_TYPED_FLOATVARIABLE_H_ */
