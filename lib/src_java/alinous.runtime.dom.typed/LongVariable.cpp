...
bool LongVariable::__init_static_variables(){
 ...
 LongVariable::LongVariable(ThreadContext* ctx) throw()  : IObject(ctx), AbstractTypedVariable(ctx), value(0)
{
}
void LongVariable::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void LongVariable::__cleanUp(ThreadContext* ctx){
}
