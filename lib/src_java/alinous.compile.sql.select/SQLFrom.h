#ifndef ALINOUS_COMPILE_SQL_SELECT_SQLFROM_H_
#define ALINOUS_COMPILE_SQL_SELECT_SQLFROM_H_
...
class SQLFrom final : public ISQLExpression {
public:
...
#endif /* end of ALINOUS_COMPILE_SQL_SELECT_SQLFROM_H_ */
