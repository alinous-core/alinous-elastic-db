...
bool SQLLimitOffset::__init_static_variables(){
 ...
 SQLLimitOffset::SQLLimitOffset(ThreadContext* ctx) throw()  : IObject(ctx), IAlinousElement(ctx), IAlinousVisitorContainer(ctx), limit(nullptr), offset(nullptr)
{
}
void SQLLimitOffset::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void SQLLimitOffset::__cleanUp(ThreadContext* ctx){
}
}}}}
