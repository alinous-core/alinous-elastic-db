...
String* ProcessRequestAction::endStr = ConstStr::getCNST_STR_3537();
...
void ProcessRequestAction::outResponse(int contentLength, OutputStream* outStream, ThreadContext* ctx)
{
	...
	if(contentLength > 0)
	{
		buff->append(ConstStr::getCNST_STR_3534(), ctx)->append(contentLength, ctx)->append(ConstStr::getCNST_STR_1862(), ctx);
	}
	buff->append(ConstStr::getCNST_STR_3535(), ctx);
	buff->append(ConstStr::getCNST_STR_1862(), ctx);
