...
{
	{
		...
		catch(InterruptedException* e)
		{
			...
			throw (new(ctx) ScanException(ConstStr::getCNST_STR_1757(), e, ctx));
		}
	}
}
...
void TableFullScanner::includes(ISQLExpression* arg0, IndexScannerLockRequirement* arg1, ThreadContext* ctx) throw() 
{
}
