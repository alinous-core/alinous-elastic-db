...
String* AddBreakpointsRequest::LINE = ConstStr::getCNST_STR_1299();
String* AddBreakpointsRequest::FILE_PATH = ConstStr::getCNST_STR_1300();
...
bool AddBreakpointsRequest::__init_static_variables(){
 ...
 AddBreakpointsRequest::AddBreakpointsRequest(ThreadContext* ctx) throw()  : IObject(ctx), IClientRequest(ctx), breakpoint(nullptr)
{
}
void AddBreakpointsRequest::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void AddBreakpointsRequest::__cleanUp(ThreadContext* ctx){
}
}}}}}
