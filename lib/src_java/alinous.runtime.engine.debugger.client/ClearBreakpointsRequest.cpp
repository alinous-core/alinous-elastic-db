...
bool ClearBreakpointsRequest::__init_static_variables(){
 ...
 ClearBreakpointsRequest::ClearBreakpointsRequest(ThreadContext* ctx) throw()  : IObject(ctx), IClientRequest(ctx)
{
}
void ClearBreakpointsRequest::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ClearBreakpointsRequest::__cleanUp(ThreadContext* ctx){
}
}}}}}
