#ifndef ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_STEPRETURNREQUEST_H_
#define ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_STEPRETURNREQUEST_H_
...
using ::alinous::runtime::engine::debugger::server::StepReturnOperation;



class StepReturnRequest final : public IClientRequest, public virtual IObject {
public:
...
#endif /* end of ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_STEPRETURNREQUEST_H_ */
