...
String* StepOverRequest::THREAD_ID = ConstStr::getCNST_STR_1297();
String* StepOverRequest::STACK_ID = ConstStr::getCNST_STR_1298();
...
bool StepOverRequest::__init_static_variables(){
 ...
 StepOverRequest::StepOverRequest(ThreadContext* ctx) throw()  : IObject(ctx), IClientRequest(ctx), threadId(0), stackId(0)
{
}
void StepOverRequest::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
{
	System::out->println(ConstStr::getCNST_STR_1301(), ctx);
...
void StepOverRequest::__cleanUp(ThreadContext* ctx){
}
}}}}}
