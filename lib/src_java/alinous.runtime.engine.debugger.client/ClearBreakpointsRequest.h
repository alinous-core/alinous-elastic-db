#ifndef ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_CLEARBREAKPOINTSREQUEST_H_
#define ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_CLEARBREAKPOINTSREQUEST_H_
...
class ClearBreakpointsRequest final : public IClientRequest, public virtual IObject {
public:
	ClearBreakpointsRequest(const ClearBreakpointsRequest& base) = default;
public:
	ClearBreakpointsRequest(ThreadContext* ctx) throw()  : IObject(ctx), IClientRequest(ctx)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~ClearBreakpointsRequest() throw();
...
#endif /* end of ALINOUS_RUNTIME_ENGINE_DEBUGGER_CLIENT_CLEARBREAKPOINTSREQUEST_H_ */
