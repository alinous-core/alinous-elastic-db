#ifndef ALINOUS_REMOTE_REGION_CLIENT_COMMAND_NODEREGIONTERMINATECOMMAND_H_
#define ALINOUS_REMOTE_REGION_CLIENT_COMMAND_NODEREGIONTERMINATECOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_REGION_CLIENT_COMMAND_NODEREGIONTERMINATECOMMAND_H_ */
