#ifndef ORG_ALINOUS_CHARSET_IBM866_H_
#define ORG_ALINOUS_CHARSET_IBM866_H_
...
class IBM866 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	IBM866(const IBM866& base) = default;
public:
	IBM866(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~IBM866() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_IBM866_H_ */
