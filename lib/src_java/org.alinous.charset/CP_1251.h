#ifndef ORG_ALINOUS_CHARSET_CP_1251_H_
#define ORG_ALINOUS_CHARSET_CP_1251_H_
...
class CP_1251 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	CP_1251(const CP_1251& base) = default;
public:
	CP_1251(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~CP_1251() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_CP_1251_H_ */
