#ifndef ORG_ALINOUS_CHARSET_CP_1250_H_
#define ORG_ALINOUS_CHARSET_CP_1250_H_
...
class CP_1250 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	CP_1250(const CP_1250& base) = default;
public:
	CP_1250(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~CP_1250() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_CP_1250_H_ */
