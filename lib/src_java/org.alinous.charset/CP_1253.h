#ifndef ORG_ALINOUS_CHARSET_CP_1253_H_
#define ORG_ALINOUS_CHARSET_CP_1253_H_
...
class CP_1253 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	CP_1253(const CP_1253& base) = default;
public:
	CP_1253(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~CP_1253() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_CP_1253_H_ */
