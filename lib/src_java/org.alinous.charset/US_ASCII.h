#ifndef ORG_ALINOUS_CHARSET_US_ASCII_H_
#define ORG_ALINOUS_CHARSET_US_ASCII_H_
...
class US_ASCII final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	US_ASCII(const US_ASCII& base) = default;
public:
	US_ASCII(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~US_ASCII() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_US_ASCII_H_ */
