#ifndef ORG_ALINOUS_CHARSET_KOI8_R_H_
#define ORG_ALINOUS_CHARSET_KOI8_R_H_
...
class KOI8_R final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	KOI8_R(const KOI8_R& base) = default;
public:
	KOI8_R(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~KOI8_R() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_KOI8_R_H_ */
