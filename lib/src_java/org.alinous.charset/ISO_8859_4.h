#ifndef ORG_ALINOUS_CHARSET_ISO_8859_4_H_
#define ORG_ALINOUS_CHARSET_ISO_8859_4_H_
...
class ISO_8859_4 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	ISO_8859_4(const ISO_8859_4& base) = default;
public:
	ISO_8859_4(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~ISO_8859_4() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_ISO_8859_4_H_ */
