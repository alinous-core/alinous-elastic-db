#ifndef ORG_ALINOUS_CHARSET_ISO_8859_5_H_
#define ORG_ALINOUS_CHARSET_ISO_8859_5_H_
...
class ISO_8859_5 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	ISO_8859_5(const ISO_8859_5& base) = default;
public:
	ISO_8859_5(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~ISO_8859_5() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_ISO_8859_5_H_ */
