#ifndef ORG_ALINOUS_CHARSET_CP_1254_H_
#define ORG_ALINOUS_CHARSET_CP_1254_H_
...
class CP_1254 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	CP_1254(const CP_1254& base) = default;
public:
	CP_1254(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~CP_1254() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_CP_1254_H_ */
