#ifndef ORG_ALINOUS_CHARSET_CP_1257_H_
#define ORG_ALINOUS_CHARSET_CP_1257_H_
...
class CP_1257 final : public CharsetConverter, public virtual IObject {
public:
	class Decoder;
	class Encoder;
	CP_1257(const CP_1257& base) = default;
public:
	CP_1257(ThreadContext* ctx) throw() ;
	void __construct_impl(ThreadContext* ctx) throw() ;
	virtual ~CP_1257() throw();
...
#endif /* end of ORG_ALINOUS_CHARSET_CP_1257_H_ */
