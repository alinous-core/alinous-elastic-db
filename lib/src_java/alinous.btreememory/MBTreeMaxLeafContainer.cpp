...
void MBTreeMaxLeafContainer::printNode(StringBuffer* buff, int level, ThreadContext* ctx)
{
	...
	buff->append(ConstStr::getCNST_STR_1582(), ctx)->append(ConstStr::getCNST_STR_1576(), ctx)->append(ConstStr::getCNST_STR_1572(), ctx);
	...
	printTab(buff, level, ctx);
	buff->append(ConstStr::getCNST_STR_1583(), ctx);
}
