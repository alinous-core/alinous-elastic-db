#ifndef ALINOUS_BTREEMEMORY_MBTREELEAFCONTAINER_H_
#define ALINOUS_BTREEMEMORY_MBTREELEAFCONTAINER_H_
...
class MBTreeLeafContainer final : public AbstractMemoryBTreeLeafContainer {
public:
	MBTreeLeafContainer(const MBTreeLeafContainer& base) = default;
public:
	MBTreeLeafContainer(IBTreeKey* key, int numNodes, IArrayObject<IBTreeNode>* nodes, ThreadContext* ctx) throw() ;
	void __construct_impl(IBTreeKey* key, int numNodes, IArrayObject<IBTreeNode>* nodes, ThreadContext* ctx) throw() ;
	virtual ~MBTreeLeafContainer() throw();
...
#endif /* end of ALINOUS_BTREEMEMORY_MBTREELEAFCONTAINER_H_ */
