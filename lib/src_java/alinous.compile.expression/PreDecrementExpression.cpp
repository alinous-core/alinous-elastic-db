...
bool PreDecrementExpression::__init_static_variables(){
 ...
 PreDecrementExpression::PreDecrementExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractExpression(ctx), exp(nullptr)
{
}
void PreDecrementExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void PreDecrementExpression::includes(IExpressionFactory* arg0, ThreadContext* ctx) throw() 
{
}
void PreDecrementExpression::__cleanUp(ThreadContext* ctx){
}
}}}
