...
void SubExpression::__construct_impl(String* op, IExpression* exp, ThreadContext* ctx) throw() 
{
 ...
 SubExpression::SubExpression(ThreadContext* ctx) throw()  : IObject(ctx), AbstractExpression(ctx), op(0), exp(nullptr)
{
}
void SubExpression::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void SubExpression::writeData(NetworkBinaryBuffer* buff, ThreadContext* ctx)
{
...
void SubExpression::includes(IExpressionFactory* arg0, ThreadContext* ctx) throw() 
{
}
void SubExpression::__cleanUp(ThreadContext* ctx){
}
}}}
