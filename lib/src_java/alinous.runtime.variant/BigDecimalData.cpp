...
void BigDecimalData::__construct_impl(BigDecimal* data, ThreadContext* ctx) throw() 
{
 ...
 BigDecimalData::BigDecimalData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
{
}
void BigDecimalData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void BigDecimalData::__cleanUp(ThreadContext* ctx){
}
