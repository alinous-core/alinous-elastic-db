...
String* TimestampData::TAG_NAME = ConstStr::getCNST_STR_1240();
...
void TimestampData::__construct_impl(Timestamp* data, ThreadContext* ctx) throw() 
{
 ...
 TimestampData::TimestampData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
{
}
void TimestampData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void TimestampData::__cleanUp(ThreadContext* ctx){
}
