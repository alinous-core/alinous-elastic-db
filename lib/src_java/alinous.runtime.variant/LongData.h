#ifndef ALINOUS_RUNTIME_VARIANT_LONGDATA_H_
#define ALINOUS_RUNTIME_VARIANT_LONGDATA_H_
...
class LongData final : public IVariantData, public virtual IObject {
public:
	LongData(const LongData& base) = default;
public:
	LongData(long long data, ThreadContext* ctx) throw() ;
	void __construct_impl(long long data, ThreadContext* ctx) throw() ;
	LongData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~LongData() throw();
...
public:
	static LongData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_LONGDATA_H_ */
