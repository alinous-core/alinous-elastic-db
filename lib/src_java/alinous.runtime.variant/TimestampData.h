#ifndef ALINOUS_RUNTIME_VARIANT_TIMESTAMPDATA_H_
#define ALINOUS_RUNTIME_VARIANT_TIMESTAMPDATA_H_
...
class TimestampData final : public IVariantData, public virtual IObject {
public:
	TimestampData(const TimestampData& base) = default;
public:
	TimestampData(Timestamp* data, ThreadContext* ctx) throw() ;
	void __construct_impl(Timestamp* data, ThreadContext* ctx) throw() ;
	TimestampData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~TimestampData() throw();
...
public:
	static TimestampData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_TIMESTAMPDATA_H_ */
