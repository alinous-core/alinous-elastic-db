#ifndef ALINOUS_RUNTIME_VARIANT_BYTEDATA_H_
#define ALINOUS_RUNTIME_VARIANT_BYTEDATA_H_
...
class ByteData final : public IVariantData, public virtual IObject {
public:
	ByteData(const ByteData& base) = default;
public:
...
public:
	static ByteData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_BYTEDATA_H_ */
