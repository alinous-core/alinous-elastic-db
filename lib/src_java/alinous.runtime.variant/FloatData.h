#ifndef ALINOUS_RUNTIME_VARIANT_FLOATDATA_H_
#define ALINOUS_RUNTIME_VARIANT_FLOATDATA_H_
...
class FloatData final : public IVariantData, public virtual IObject {
public:
	FloatData(const FloatData& base) = default;
public:
	FloatData(float data, ThreadContext* ctx) throw() ;
	void __construct_impl(float data, ThreadContext* ctx) throw() ;
	FloatData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(0)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~FloatData() throw();
...
public:
	static FloatData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_FLOATDATA_H_ */
