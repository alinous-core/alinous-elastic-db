#ifndef ALINOUS_RUNTIME_VARIANT_STRINGDATA_H_
#define ALINOUS_RUNTIME_VARIANT_STRINGDATA_H_
...
class StringData final : public IVariantData, public virtual IObject {
public:
	StringData(const StringData& base) = default;
public:
	StringData(String* data, ThreadContext* ctx) throw() ;
	void __construct_impl(String* data, ThreadContext* ctx) throw() ;
	StringData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~StringData() throw();
...
public:
	static StringData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_STRINGDATA_H_ */
