#ifndef ALINOUS_RUNTIME_VARIANT_TIMEDATA_H_
#define ALINOUS_RUNTIME_VARIANT_TIMEDATA_H_
...
class TimeData final : public IVariantData, public virtual IObject {
public:
	TimeData(const TimeData& base) = default;
public:
	TimeData(TimeOnlyTimestamp* data, ThreadContext* ctx) throw() ;
	void __construct_impl(TimeOnlyTimestamp* data, ThreadContext* ctx) throw() ;
	TimeData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
	{
	}
	void __construct_impl(ThreadContext* ctx) throw() 
	{
	}
	virtual ~TimeData() throw();
	virtual void __releaseRegerences(bool prepare, ThreadContext* ctx) throw();
private:
	TimeOnlyTimestamp* data;
public:
...
public:
	static TimeData* importFromXml(DomNode* node, ThreadContext* ctx) throw() ;
public:
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_TIMEDATA_H_ */
