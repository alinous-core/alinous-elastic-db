#ifndef ALINOUS_RUNTIME_VARIANT_CHARDATA_H_
#define ALINOUS_RUNTIME_VARIANT_CHARDATA_H_
...
class CharData final : public IVariantData, public virtual IObject {
public:
	CharData(const CharData& base) = default;
public:
	CharData(wchar_t data, ThreadContext* ctx) throw() ;
	void __construct_impl(wchar_t data, ThreadContext* ctx) throw() ;
	CharData(ThreadContext* ctx) throw() ;
...
#endif /* end of ALINOUS_RUNTIME_VARIANT_CHARDATA_H_ */
