...
String* StringData::TAG_NAME = ConstStr::getCNST_STR_1239();
...
void StringData::__construct_impl(String* data, ThreadContext* ctx) throw() 
{
 ...
 StringData::StringData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
{
}
void StringData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void StringData::__cleanUp(ThreadContext* ctx){
}
