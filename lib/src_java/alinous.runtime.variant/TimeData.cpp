...
String* TimeData::TAG_NAME = ConstStr::getCNST_STR_1221();
...
void TimeData::__construct_impl(TimeOnlyTimestamp* data, ThreadContext* ctx) throw() 
{
 ...
 TimeData::TimeData(ThreadContext* ctx) throw()  : IObject(ctx), IVariantData(ctx), data(nullptr)
{
}
void TimeData::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void TimeData::__cleanUp(ThreadContext* ctx){
}
