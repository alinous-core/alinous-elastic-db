...
bool DomComment::__init_static_variables(){
 ...
 DomComment::DomComment(ThreadContext* ctx) throw()  : IObject(ctx), DomNode(ConstStr::getCNST_STR_1758(), ctx), buff(__GC_INS(this, (new(ctx) StringBuffer(ctx)), StringBuffer))
{
	this->buff->append(ConstStr::getCNST_STR_1759(), ctx);
}
