...
bool ISQLExpressionPart::__init_static_variables(){
 ...
 ISQLExpressionPart::ISQLExpressionPart(ThreadContext* ctx) throw()  : IObject(ctx), ISQLExpression(ctx)
{
}
void ISQLExpressionPart::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void ISQLExpressionPart::__cleanUp(ThreadContext* ctx){
}
}}}}
