#ifndef ALINOUS_REMOTE_MONITOR_CLIENT_COMMAND_FINISHCONNECTIONCOMMAND_H_
#define ALINOUS_REMOTE_MONITOR_CLIENT_COMMAND_FINISHCONNECTIONCOMMAND_H_
...
#endif /* end of ALINOUS_REMOTE_MONITOR_CLIENT_COMMAND_FINISHCONNECTIONCOMMAND_H_ */
