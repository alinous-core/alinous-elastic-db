...
bool GroupedScanResultRecord::__init_static_variables(){
 ...
 GroupedScanResultRecord::GroupedScanResultRecord(ThreadContext* ctx) throw()  : IObject(ctx), ScanResultRecord(ctx)
{
}
void GroupedScanResultRecord::__construct_impl(ThreadContext* ctx) throw() 
{
}
...
void GroupedScanResultRecord::__cleanUp(ThreadContext* ctx){
}
}}}}
